...
void test_assign_rvalue() {
#if TEST_STD_VER >= 11
  static_assert(!std::is_assignable<std::string_view, std::string&&>::value, "");
  static_assert(!std::is_assignable<std::string_view, const std::string&&>::value, "");
  static_assert(!std::is_assignable<std::string_view, std::string>::value, "");
  static_assert(!std::is_assignable<std::string_view, const std::string>::value, "");
#endif
}
